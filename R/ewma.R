...
#' @export
#'
#' @return Returns a numerical vector \emph{vol} that contains the computed volatilities.
#'
#' @examples
...
#' csig <- sqrt(cvar)
#' plot(date, csig, type = "l", main = "conditional standard deviations for the DAX30 return series")
