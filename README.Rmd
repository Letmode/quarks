...
To further analyze these results one might apply backtesting
...
* ```rollcast````: Computes rolling one-step forecasts of Value at Risk and Expected Shortfall
...
* ```DAX30```: Daily financial time series data of the German Stock Market Index (DAX)
